...
#--- from root OIL file lab3_ex3.oil
#---
...
sys.path.append("/home/alizeinkhalifeh/alizein/file1/trampoline/make")
...
includeDirs += ["-I","/home/alizeinkhalifeh/alizein/file1/trampoline/machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/home/alizeinkhalifeh/alizein/file1/trampoline/machines/avr/arduino/"]
includeDirs += ["-I","/home/alizeinkhalifeh/alizein/file1/trampoline/machines/avr/arduino/variants/standard"]
includeDirs += ["-I","/home/alizeinkhalifeh/alizein/file1/trampoline/machines/avr"]
includeDirs += ["-I","/home/alizeinkhalifeh/alizein/file1/trampoline/machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/home/alizeinkhalifeh/alizein/file1/trampoline/machines/avr/arduino/cores/arduino"]
if with_ioc:
  includeDirs += ["-I", "/home/alizeinkhalifeh/alizein/file1/trampoline/ioc"]
includeDirs += ["-I", "/home/alizeinkhalifeh/alizein/file1/trampoline/com"]
includeDirs += ["-I", "/home/alizeinkhalifeh/alizein/file1/trampoline/os"]
includeDirs += ["-I", "/home/alizeinkhalifeh/alizein/file1/trampoline/debug"]
includeDirs += ["-I", "lab3_ex3"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("lab3_ex3.oil")
...
cflags += ["-I", "/home/alizeinkhalifeh/alizein/file1/trampoline/com"]
cppflags += ["-I", "/home/alizeinkhalifeh/alizein/file1/trampoline/com"]
...
cSourceList.append(projfile.ProjectFile("Lab3_ex3.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab3_ex3/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab3_ex3/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab3_ex3/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab3_ex3/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary Lab3_ex3_exe.hex from Lab3_ex3_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("Lab3_ex3_exe")
  postCommand.mCommand.append("Lab3_ex3_exe.hex")
...
postVariableMapping = dict(
  MACHINE_PATH='/home/alizeinkhalifeh/alizein/file1/trampoline/machines',
  ARCH_PATH='/home/alizeinkhalifeh/alizein/file1/trampoline/machines/avr',
  BOARD_PATH='/home/alizeinkhalifeh/alizein/file1/trampoline/machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing Lab3_ex3_exe on avr/arduino/uno\033[0m")
