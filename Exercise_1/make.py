...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab3_ex1.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=/home/alizeinkhalifeh/alizein/file1/trampoline/goil/templates/ lab3_ex1.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("lab3_ex1/tpl_app_config.c")

sourceList.append("lab3_ex1/tpl_dispatch_table.c")
sourceList.append("lab3_ex1/tpl_invoque.S")
sourceList.append("lab3_ex1/tpl_interrupts.c")
