...
#--- from root OIL file lab3_ex1.oil
#---
...
#--- OIL file
oilSourceList.append("lab3_ex1.oil")
...
cSourceList.append(projfile.ProjectFile("Lab3_ex1.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab3_ex1/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab3_ex1/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab3_ex1/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab3_ex1/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary Lab3_ex1_exe.hex from Lab3_ex1_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("Lab3_ex1_exe")
  postCommand.mCommand.append("Lab3_ex1_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing Lab3_ex1_exe on avr/arduino/uno\033[0m")
